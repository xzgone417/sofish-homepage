  ...
  var thim_startertheme = {
    ...
    header_menu_mobile: function () {
      ...
      $(document).on("click", ".mobile-menu-open", function () {
        $("#wrapper-container.mobile-menu-open").removeClass(
          "mobile-menu-open"
        );
        $("body").css("overflow", "auto");
      });
      ...
      $(".js-call-slick-col").each(function () {
        ...
        $(slideSlick)
          .slick({
            ...
            rtl: parameter.rtl,
            vertical: parameter.verticalSlide, //垂直滑动方向
            verticalSwiping: parameter.verticalSwiping, //垂直滑动方向
            pauseOnFocus: false,
            pauseOnHover: true,
            slidesToShow: parameter.slidesToShow, //要显示的幻灯片数
            slidesToScroll: parameter.slidesToScroll, //要滚动的幻灯片数
            fade: parameter.fade,
            infinite: parameter.infinite,
            autoplay: parameter.autoplay, //是否自动播放
    ...
    filter_full_container: function () {
      try {
