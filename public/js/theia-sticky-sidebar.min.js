 ...
 */ (function ($) {
  $.fn.theiaStickySidebar = function (options) {
    ...
    function init(options, $that) {
      ...
      $that.each(function () {
        var myAdditionalMarginTop = options.additionalMarginTop;
        var o = {};
        o.sidebar = $(this);
        o.options = options || {};
        ...
        o.onScroll = function (o) {
          ...
          if (
            ...
            if (options.typeSticky === 1) {
              if (scrollTop > o.previousScrollTop) {
                myAdditionalMarginTop = options.spacingTopDefault;
              } else {
                myAdditionalMarginTop = options.additionalMarginTop;
              }
            }
            var offsetTop = o.paddingTop + o.marginTop + myAdditionalMarginTop;
            var offsetBottom =
              o.paddingBottom + o.marginBottom + options.additionalMarginBottom;
            var containerTop = o.container.offset().top;
            var containerBottom =
              o.container.offset().top + getClearedHeight(o.container);
            var windowOffsetTop = 0 + myAdditionalMarginTop;
