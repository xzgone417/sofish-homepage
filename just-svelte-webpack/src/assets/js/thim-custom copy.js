(function ($) {
  ...
  var thim_startertheme = {
    ...
    header_menu: function () {
      ...
      var startFixed =
        $elementToStick.length > 0
          ? $elementToStick.offset().top - dentalTop
          : 0;
      ...
      $(window).scroll(function () {
        ...
        if (
          current > latestScroll &&
          current > $elementToStick.outerHeight() + startFixed
        ) {
    ...
    header_menu_mobile: function () {
      ...
      $(document).on("click", ".mobile-menu-open", function () {
        $(".responsive #wrapper-container.mobile-menu-open").removeClass(
          "mobile-menu-open"
        );
        $("body").css("overflow", "auto");
      });
      ...
      $(".js-call-slick-col").each(function () {
        ...
        $(slideSlick)
          .slick({
            ...
            verticalSwiping: parameter.verticalSwiping,
            pauseOnFocus: false,
            pauseOnHover: true,
            slidesToShow: parameter.slidesToShow,
            slidesToScroll: parameter.slidesToScroll,
            fade: parameter.fade,
            infinite: parameter.infinite,
            autoplay: parameter.autoplay,
            autoplaySpeed: parameter.autoplaySpeed,
            arrows: showArrow,
          ...
          .on("setPosition", function (event, slick) {
            if (
              $(this).parent().data("equalheight") === "1" ||
              $(this).parent().data("equalheight") === 1
            ) {
              var maxHeight = 0;
            ...
            if (parameter.middlearrow != null) {
              ...
              var middleOf = $(wrapSlick)
                .find(parameter.middlearrow)
                .outerHeight();
        ...
        function showLayer(currentSlide) {
          var layerCurrentItem = $(itemSlick[currentSlide]).find(
            "[data-appear]"
          );
          ...
          $(layerSlick).each(function () {
            $(this)
              .removeClass($(this).data("appear"))
              .css("visibility", "hidden");
          });
          for (var i = 0; i < layerCurrentItem.length; i++) {
            actionSlick[i] = setTimeout(
              function (index) {
                $(layerCurrentItem[index])
                  .addClass($(layerCurrentItem[index]).data("appear"))
    ...
    login_error: function () {
      ...
      $(".login-popup form#registerform").submit(function (event) {
        ...
        if (
          input_pass.val() !== input_rppass.val() ||
          input_pass.val() === ""
        ) {
          input_pass.addClass("invalid");
        ...
        $(document).on("click", ".wrap-num-product .btn-num-down", function () {
          ...
          if (numProduct > 0)
            $(this)
              ...
              .find(".num-product")
              .val(numProduct - 1);
          $('.woocommerce-cart-form button[name="update_cart"]').removeAttr(
            "disabled"
          );
        });
    ...
    thim_tabs: function () {
      try {
        $(".js-call-tabs").each(function () {
          ...
          var getPanelActive = $(navTabs)
            .find(".item-nav.active")
            .data("panel");
          $(contentTabs)
            .find(".tab-panel[data-nav='" + getPanelActive + "']")
            .show();
          $(contentTabs)
            .find(".tab-panel[data-nav='" + getPanelActive + "']")
            .addClass("active");
          $(navTabs)
            ...
            .each(function () {
              $(this).on("click", function (e) {
                ...
                $(contentTabs)
                  .find(".tab-panel[data-nav='" + getPanel + "']")
                  .show();
                $(contentTabs)
                  .find(".tab-panel[data-nav='" + getPanel + "']")
                  .addClass("active");
